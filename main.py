...
def main():
    ...
    Керує взаємодією користувача з магазином іграшок через консольний інтерфейс.
    Дозволяє додавати, переглядати, редагувати, видаляти іграшки та оформляти замовлення.
    """
    ...
    while True:
        ...
        if choice == '1':
            ...
            toy = store.find_toy_by_name(toy_name)
            if not toy:
